...
URL = "https://github.com/OpenVoiceOS/my-skill-test"
SKILL_CLAZZ = "MySkillTest"  # needs to match __init__.py class name
PYPI_NAME = "my-skill-test"  # pip install PYPI_NAME
...
setup(
    name=PYPI_NAME,
    version=get_version(),
    description='my skill test plugin',
